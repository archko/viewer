...
public class MuPDFPage extends ArDkPage
{
    ...
    void createSignatureAt(final PointF point)
    {
        ...
        PDFWidget widget = null;//pdfPage.createSignature();
        if (widget!=null)
        {
            //  get the rect
    ...
    public static Quad rectToQuad(Rect r)
    {
        Quad quad =
                new Quad(
                        r.x0, r.y0,
    ...
    public static Quad [] rectsToQuads(Rect[] rects)
    {
        Quad[] quads = new Quad[rects.length];
        int i = 0;
        for (Rect r:rects)
        {
    ...
    public void addRedactAnnotation(android.graphics.Rect r)
    {
        ...
        //  array of quads
        Rect rf = new Rect(r.left, r.top, r.right, r.bottom);
        Rect[] rfs = {rf};
